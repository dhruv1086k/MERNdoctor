        ...
        <div
          ...
          className={` ${
            item.available === true
              ...
              : "bg-white cursor-pointer rounded-xl shadow-sm p-4 w-64 text-center border border-gray-200 opacity-60"
          }`}
        >
          <img
            src={item.image}
          ...
          <div
            className="flex items-center justify-start mt-3 cursor-pointer"
            onClick={() => handleAvailabilityChange(item._id)}
          >
            {item.available ? (
